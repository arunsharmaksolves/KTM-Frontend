...
const Analytics = () => {
  ...
  const generateCsv = () => {
    ...
    // Add data rows
    trigger.forEach((t) => {
      const row = `${t.target.tagName},${t.target.innerText},${t.event},${t.location.city},${t.location.country},${(t.timeSpent * 10).toFixed(2)}\n`;
      csvContent += row;
    });
        ...
        <div className="p-4 border-2 border-slate-950 border-solid rounded-lg   ">
          <div className="flex justify-between">
            ...
            <button
             ...
             onClick={generateCsv}>Generate CSV</button>
          </div>
